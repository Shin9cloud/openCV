...
# YCrCb 색 평면 분할
src_hsb =cv2.cvtColor(src, cv2.COLOR_BGR2YCrCb)
Y_plane, Cr_plane, Cb_plane = cv2.split(src_hsb)
...
# #HUE 색 평면 분활
# ycbcr =cv2.cvtColor(src, cv2.COLOR_BGR2YCR_CB)
# Y_plane, CR_plane, CV_plane = cv2.split(ycbcr)
# # RGB 색 평면 분할
